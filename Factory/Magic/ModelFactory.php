...
use FOF30\Factory\Magic\BaseFactory;
...
class ModelFactory extends BaseFactory
{
	...
	public function make($name = null, array $config = array())
	{
		...
		$dataModelClassName = $this->container->getNamespacePrefix($this->getSection()) . 'Model\\' . $this->container->inflector->singularize($name);
